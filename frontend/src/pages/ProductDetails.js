      ...
      <div className=" min-h-[200px] flex flex-col lg:flex-row gap-4">
        ...
        {loading ? (
          <div className="grid gap-1 w-full">
            ...
            <div className="flex items-center gap-2 text-2xxl font-medium lg:text-3xl my-1 h-6 animate-pulse">
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="flex items-center gap-3 my-2">
              <button
                ...
                className="border-2 border-blue-400 rounded px-3 py-1 min-w-[120px] text-blue-500 hover:bg-blue-500 hover:text-white"
              >
                Buy
              </button>
              <button
                onClick={(e) => handleAddTOCart(e, data?._id)}
                className="border-2 border-blue-400 rounded px-3 py-1 min-w-[120px]  bg-blue-400 text-white hover:text-blue-500 hover:bg-slate-100"
              >
                Add To Cart
              </button>
            </div>
